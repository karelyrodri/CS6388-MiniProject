"""
This script is called by the plugin-wrapper, ClassificationPlugin.js, which passes down the
...
from ClassificationPlugin import ClassificationPlugin
...
plugin = ClassificationPlugin(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
